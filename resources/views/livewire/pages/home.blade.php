<div x-data="letterAnimator" x-init="start()" >
    <section class="w-full flex items-center justify-center min-h-screen overflow-hidden ">
        ...
        <div class="relative z-10 container mx-auto px-4 text-center text-white">
            ...
            La plateforme publicitaire des <span class="text-lime-500">meilleures</span> écoles, <span class="relative whitespace-nowrap text-purple-400 dark:text-purple-400">
