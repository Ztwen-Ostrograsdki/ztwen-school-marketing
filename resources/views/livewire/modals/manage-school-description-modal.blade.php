            ...
            <div class="relative bg-black/80 border border-sky-500 rounded-lg shadow-2xl">
                ...
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600 border-gray-200">
                    <h3 class="text-sm sm:text-lg font-semibold text-lime-500 letter-spacing-1">
                        ...
                        Mise à jour de la description école
                    </h3>
                ...
                <form wire:submit.prevent="insert" class="p-4 md:p-5">
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        <div class="col-span-2">
                            <label for="description" class="block mb-2 text-sm text-amber-400 font-medium ">La description de votre école</label>
                            <textarea cols="30" rows="10" wire:model.blur='description' type="text" name="description" id="description" class="bg-transparent border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5   dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Veuillez décrire votre école ici..." >
